...
void login(String ip,String user_account,String yys,String password)
{
  String auth = user_account + "@" + yys;
...
void setup()
{
  ...
  wifiMulti.addAP("duya25446", "Duya25446");
  while(wifiMulti.run() != WL_CONNECTED)
  {
    Serial.print(".");
    delay(500);
  }
  login(GetIp(),"20202378024","telecom","283835");
}
